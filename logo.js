...
function logo() {
  ...
  return(
    ...
    color5+'  _'+color1+'\\/\\\\\\'+color5+'_________________'+color2+'\\/\\\\\\'+color5+'_____'+color3+'\\/\\\\\\_____\\/\\\\\\'+color5+'_______'+color4+'\\/\\\\\\'+color5+'_____'+ '\n' +      
    color5+'   _'+color1+'\\/\\\\\\'+color5+'_________________'+color2+'\\/\\\\\\'+color5+'_____'+color3+'\\/\\\\\\\\\\\\\\\\\\\\\\/'+color5+'________'+color4+'\\/\\\\\\'+color5+'_____'+ '\n' +     
    color5+'    _'+color1+'\\/\\\\\\'+color5+'_________________'+color2+'\\/\\\\\\'+color5+'_____'+color3+'\\/\\\\\\//////\\\\\\'+color5+'________'+color4+'\\/\\\\\\'+color5+'_____'+ '\n' +    
    color5+'     _'+color1+'\\/\\\\\\'+color5+'_________________'+color2+'\\/\\\\\\'+color5+'_____'+color3+'\\/\\\\\\____\\//\\\\\\'+color5+'_______'+color4+'\\/\\\\\\'+color5+'_____'+ '\n' +   
    color5+'      _'+color1+'\\/\\\\\\'+color5+'_________________'+color2+'\\/\\\\\\'+color5+'_____'+color3+'\\/\\\\\\_____\\//\\\\\\'+color5+'______'+color4+'\\/\\\\\\'+color5+'_____'+ '\n' +  
    color5+'       _'+color1+'\\/\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\'+color5+'__'+color2+'/\\\\\\\\\\\\\\\\\\\\\\'+color5+'_'+color3+'\\/\\\\\\______\\//\\\\\\'+color5+'__'+color4+'/\\\\\\\\\\\\\\\\\\\\\\'+color5+'_'+ '\n' + 
    color5+'        _'+color1+'\\///////////////'+color5+'__'+color2+'\\///////////'+color5+'__'+color3+'\\///________\\///'+color5+'__'+color4+'\\///////////'+color5+'__'+'\x1b[0m');
};
